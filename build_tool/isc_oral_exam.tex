...
\lstdefinelanguage{scala}{
  style=framed,
  numbers = left,
  numberstyle = {\scriptsizettfamily\color{listing-numbers}\noncopynumber},
  stepnumber =1,
  numbersep = 15pt,
  basicstyle={\footnotesizettfamily\color{hei_dark}},
  morekeywords={%
...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \includegraphics[height=1.9cm]{figs/ISC Logo inline black v3.pdf.pdf}
	};
\end{tikzpicture}
